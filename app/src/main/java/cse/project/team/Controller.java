...
public class Controller {
    ...
    private void handleCreateButton(ActionEvent event){
        String account = loginView.userAccount();
        String password = loginView.userPassword();

        Stage popupStage = new Stage();
        popupStage.setTitle(account);
        popupStage.initModality(Modality.APPLICATION_MODAL);
        Label messageLabel = new Label(password);
        ...
        model.performRequest("PUT",account,password, "password");
        setListScene();
    }
    ...
    private void handleLoginButton(ActionEvent event){
        String account = loginView.userAccount();
        String password = loginView.userPassword();
        String pw = model.performRequest("GET", account, null, "password");
        ...
        popupStage.initModality(Modality.APPLICATION_MODAL);
        Label messageLabel = new Label(pw);
        VBox layout = new VBox(10);
        layout.getChildren().add(messageLabel);
        Scene scene = new Scene(layout, 300, 200);
        popupStage.setScene(scene);
